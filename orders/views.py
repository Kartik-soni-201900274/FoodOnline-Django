        ...
        for i in cart_items:
            if i.fooditem.vendor.user.email not in to_emails:
                ...
                ordered_food_to_vendor = OrderedFood.objects.filter(
                    order=order, fooditem__vendor=i.fooditem.vendor
                )
                ...
                context = {
                    ...
                    "vendor_subtotal": order_total_by_vendor(
                        order, i.fooditem.vendor.id
                    )["subtotal"],
                    "tax_data": order_total_by_vendor(order, i.fooditem.vendor.id)[
                        "tax_dict"
                    ],
                    "vendor_grand_total": order_total_by_vendor(
                        order, i.fooditem.vendor.id
                    )["grand_total"],
                }
                send_notification(mail_subject, mail_template, context)
